...
_Generated: 2026-07-20T11:48:32.990539+00:00_

**Status:** ok - metrics computed.

Model artifact: `/home/runner/work/patchpilot/patchpilot/.mlruns/run-b291b38737-20260720T114828/model.pkl`  
Model version: `lgbm@v0.1.0`  
Trained at: `2026-07-20T11:48:28.906055+00:00`  
Features: 18
...
| ----- | ------ | ------- | ----- | ----- | --- |
| PatchPilot | 0.0173 | 0.8077 | 0.0100 | 0.0025 | 0.0001 |
...
**Evaluation integrity:** EPSS-complement strategy active: PatchPilot = clamp01(EPSS + residual). Lift over EPSS on this holdout is delta-AUC-PR = +0.0148 (above the EPSS-only baseline).
