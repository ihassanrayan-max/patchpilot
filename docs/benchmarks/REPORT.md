...
_Generated: 2026-08-10T09:56:38.255369+00:00_

**Status:** ok - metrics computed.

Model artifact: `/home/runner/work/patchpilot/patchpilot/.mlruns/run-872a52e6fc-20260810T095634/model.pkl`  
Model version: `lgbm@v0.1.0`  
Trained at: `2026-08-10T09:56:34.080307+00:00`  
Features: 18
...
| ----- | ------ | ------- | ----- | ----- | --- |
| PatchPilot | 0.0167 | 0.8277 | 0.0000 | 0.0025 | 0.0002 |
...
**Evaluation integrity:** EPSS-complement strategy active: PatchPilot = clamp01(EPSS + residual). Lift over EPSS on this holdout is delta-AUC-PR = +0.0141 (above the EPSS-only baseline).
